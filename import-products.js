// projectId rptf6brb
// Read/write token, no settings
// Name: CLI-script
// sk3tBMtZS7B1ryquyGagwFY4rTils1ZGhgF1DwpisU5c1jGyhDAbqqmF3YD5GdMIkXdPyAcoFds7z8FZjT3u7JhaZfIrfeZZJVQVlFbgIJKiKDef8NILHSrbVvyR8edpBlNVozRa4u506tVvjqKx5pqyGnjzAKSvQjUJu1G4Y6O4xdCdgB07
...
const client = createClient({
 projectId: 'rptf6brb', // EDIT: Replace with your actual Sanity project ID (found in sanity.json or project settings) 
 dataset: 'production', // EDIT: Change to 'development' if importing to dev dataset first
 useCdn: false,
 token: 'sk3tBMtZS7B1ryquyGagwFY4rTils1ZGhgF1DwpisU5c1jGyhDAbqqmF3YD5GdMIkXdPyAcoFds7z8FZjT3u7JhaZfIrfeZZJVQVlFbgIJKiKDef8NILHSrbVvyR8edpBlNVozRa4u506tVvjqKx5pqyGnjzAKSvQjUJu1G4Y6O4xdCdgB07', 
 // EDIT: Replace with your write token from sanity.io/manage → your project → API → Tokens
